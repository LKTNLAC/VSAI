...
const TRANSLATIONS = {
    vi: {
        ...
        { 
            ...
            cta: 'Tìm hiểu thêm về Hội sinh viên Việt Nam tại Ấn Độ', 
            image: 'Ảnh hoạt động Hội sinh viên Việt Nam tại Ấn Độ' },
        activities: { title: 'Hoạt động nổi bật', viewAll: 'Xem tất cả →', page: { subtitle: 'Các hoạt động và sự kiện của Hội sinh viên Việt Nam tại Ấn Độ' } },
        news: { title: 'Tin tức mới nhất', viewAll: 'Xem tất cả →', page: { subtitle: 'Cập nhật mới nhất từ Hội sinh viên Việt Nam tại Ấn Độ' }, featured: 'Tin nổi bật' },
